...
2. **Clone your labs repo.**
    ...
    *always* the one in GitLab, so to keep everything synchronized, after editing
    ...
    If you see a dialog box asking "Would you like to create an IntelliJ IDEA
    project for the sources you have checked out ...", select "No", then select
    "Open" and find the project that you just checked out - it should be in your
    home directory under `IdeaProjects/comp1110-labs`. (This is a bug in the
